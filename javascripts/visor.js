...
function mapReady(map) {
    ...
    identifyTask = new esri.tasks.IdentifyTask("https://gisponal.policia.gov.co/arcgis/rest/services/DIJIN/SIDENCO_SinMalla/MapServer");
...
function executeIdentifyTask(evt) {
    ...
    mapa.infoWindow.show(evt.mapPoint, mapa.getInfoWindowAnchor(evt.screenPoint));*/
        var qtCuadrantes = new esri.tasks.QueryTask("https://gisponal.policia.gov.co/arcgis/rest/services/DIJIN/SIDENCO_SinMalla/MapServer/11");	
    var qCuadrantes = new esri.tasks.Query();
	var qtEstaciones = new esri.tasks.QueryTask("https://gisponal.policia.gov.co/arcgis/rest/services/DIJIN/SIDENCO_SinMalla/MapServer/9");
